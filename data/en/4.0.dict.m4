...
% Just like words.n.2.s, but with a cost, so that "numbers of" gets priority
numbers.n:
  [<marker-common-entity> or <generic-plural-id>];
...
extent.d gob.d heap.d hunk.d load.d magnitude.d
mass.d measure.d mess.d mint.d passel.d peck.d pile.d 
raft.d slew.d stack.d supply.d ton.d volume.d
sum.d wad.d 
assembly.d army.d bevy.d cloud.d collection.d colony.d
company.d convoy.d crowd.d crush.d
...
% NIn+ needed for omney amounts
numbers.d mucho.d oodles.d scads.d
bags.d bunches.d bundles.d chunks.d expanses.d extents.d
gobs.d heaps.d hunks.d loads.d masses.d piles.d rafts.d
stacks.d tons.d volumes.d sums.d wads.d
...
% XXX FIXME:
% EB- is difficult ...
%   it is not sweet         % not is modifying "is" (and that's OK)
%   *it tastes not sweet       
%   it tastes bitter, not sweet   % not is modifying comma    
%   it tastes bitter and not sweet  % not is modifying "and" (probably OK)
%
not.e: 
  EBm-
  or (EBb- & EA+)
