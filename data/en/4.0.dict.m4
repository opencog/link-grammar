...
%
% <to-verb> & <verb-wall>: "I have to ..." means have can connect to wall.
<vc-have>:
  ({@MV+} & <to-verb> & <inf-verb> & <verb-wall>)
...
<vc-be-no-obj>:
  ({@EBm+} & ((([{CV-} & B**t-] or [K+] or (<verb-wall> & BI+) or OF+ or PF- or
      (Osi+ & R+ & Bs+ & <verb-wall>) or
      (Opi+ & R+ & Bp+ & <verb-wall>) or
      [[()]]) & {@MV+}) or
...
(Pp+ & {THi+ or @MV+}) or THb+ or <to-verb> or (Pa+ & <verb-wall>))) or ({Pp+} & Pg+) or Pv+ or PP+)) or
(SIs+ & PF-)]];
...
going.v:
  ((<tof-verb> or ({K+ or [[Pa+]]} & {@MV+})) & <verb-x-pg,ge> & <verb-wall>) or
  ({@E-} & A+) or
  <verb-ge-d>;
...
<vc-take>:
  ...
  ({O+} & (OT+ or BT-) & {@MV+} & {(TOt+ & B+) or <toi-verb>}) or
  (OXii+ & Vtg+ & {@MV+} & TH+) or
  @MV+;
...
{<tof-verb> or THi+ or Z-}) or ({@E-} & A+) or ({@MV+} & {<to-verb>} & <verb-phrase-opener>);
...
intended.v-d: VERB_SPPP_T(<vc-intend>) or (<verb-pv> & {<to-verb> or Z- or @MV+})
 or ({@E-} & A+) or ({@MV+} & {<to-verb>} & <verb-phrase-opener>);
...
(<verb-pv> & {<to-verb> or TSi+}) or ({@E-} & A+) or ({@MV+} & {<to-verb>} & <verb-phrase-opener>);
...
(({@MV+} & (<tof-verb> or Pa+)) or ({O+ or B- or [[@MV+ & O*n+]]} & {@MV+})))
...
({@E-} & A+) or ({@MV+} & {<to-verb>} & <verb-phrase-opener>);
...
cautioned.v-d:
  ...
  or (<verb-pv> & ((O+ or B-) & {@MV+} & {TH+ or <embed-verb> or Zs- or <to-verb>}))
...
(<verb-pv-b> & (({O+ or B- or [[@MV+ & O*n+]]} & {@MV+}) or ({@MV+} & <to-verb>)))
...
% ditransitive
<vc-promise>:
  ({O+ or B-} & {@MV+} & {B- or <to-verb> or <embed-verb> or TH+ or RSe+ or Zs-}) or
  ((<vc-ditrans> or
    ([[@MV+ & O*n+]])) & {@MV+});
...
promised.v-d:
  ...
  or (<verb-pv-b> & (({O+ or B- or [[@MV+ & O*n+]]} & {@MV+}) or ({@MV+} & (<to-verb> or <embed-verb> or TH+ or RSe+ or Zs-))))
  or ({@E-} & A+)
...
(O+ or TI+ or [[@MV+ & (O*n+ or TI+)]])} & {@MV+}) or ({@MV+} & <to-verb>)))
...
ago:
  Yt- & (<prep-main-e> or <advcl-verb> or Qe+ or JT- or Js-);
...
easy.a hard.a simple.a difficult.a fun.a expensive.a:
  {EA- or EF+} &
    (({[[@Ec-]]} & {Xc+} & A+) or
    ((Paf- or AF+ or Ma- or MJra-) & {@MV+} & {((TOt+ & B+) or <toi-verb>) & {LE+}}) or
    ({@MV+} & {((TOt+ & B+) or <toi-verb>) & {LE+}} & MJla+) or
    AA+ or
    [[DD- & <noun-main-p>]] or
    [[{DD-} & <noun-and-p>]] or
    ({TOt+ & B+} & <adj-op>));
...
ready.a:
  {EA- or EF+} & (
    ({[[@Ec-]]} & {Xc+} & A+)
    or ((Pa- or AF+ or Ma- or MJra-) & {@MV+} & {((TOt+ & B+) or <to-verb>) & {LE+}})
    or ({@MV+} & {((TOt+ & B+) or <to-verb>) & {LE+}} & MJla+)
    or AA+
    or M-
    or [[DD- & <noun-main-p>]]
    or [[{DD-} & <noun-and-p>]]
    or ({<to-verb> or (TOt+ & B+)} & <adj-op>));
...
<adj-good>:
  {EA- or EF+} &
    (({[[@Ec-]]} & {Xc+} & A+) or
    ((Paf- or AF+ or Ma- or MJra-) & {@MV+} & {((TOt+ & B+) or THi+ or <toi-verb>) & {LE+}}) or
    ({@MV+} & {((TOt+ & B+) or THi+ or <toi-verb>) & {LE+}} & MJla+) or
    AA+ or
    [[DD- & <noun-main-p>]] or
    [[{DD-} & <noun-and-p>]] or
    ({TOt+ & B+} & <adj-op>));
...
important.a essential.a crucial.a necessary.a imperative.a vital.a:
  ...
  ({EA- or EF+} &
    (({[[@Ec-]]} & {Xc+} & A+) or
    ((Paf- or AF+ or Ma- or MJra-) & (({@MV+} & {(THi+ or <toi-verb> or TSi+) & {LE+}}) or (TOt+ & B+))) or
    ((({@MV+} & {(THi+ or <toi-verb> or TSi+) & {LE+}}) or (TOt+ & B+)) & MJla+) or
    AA+ or
    [[DD- & <noun-main-p>]] or
    [[{DD-} & <noun-and-p>]] or
    ({TOt+ & B+} & <adj-op>)));
...
easier.a-c:
  ({ECa-} &
    (({[[@Ec-]]} & {Xc+} & Am+) or
    ((Pafm- or AFm+ or Mam- or AJrc-) & {@MV+} & {((TOt+ & B+) or <toi-verb>) & {LE+}}) or
    AJlc+)) or
  (DG- & (TR+ or AF+) & {@MV+} & {(TOt+ & B+) or <toi-verb>} & (ER- or (Wd- & Xc+ & ER+)));
...
({Xc+ & {Xd-}} & CO+) or Qe+ or <advcl-verb>)) or (Kx- & Ky+) or (Pp- & Pp+);
