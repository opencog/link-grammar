...
% agreement.
% ({{Dmu-} & Jd-} & Dmc-) : "I gave him a number of the cookies"
<generic-plural-id>:  
  [[AN+]] or
  (<noun-modifiers> & 
    (({NM+ or ({{Dmu-} & Jd-} & Dmc-)} & <noun-sub-p> & (<noun-main-p> or <rel-clause-p>)) or
...
some_more:
  MVa- or Dm+ or (<noun-sub-x> & <noun-main-x>) or <noun-and-x>;

one_more:
  Ds+ or (<noun-sub-s> & <noun-main-s>) or <noun-and-s>;

not_many:
  Dmc+ or (<noun-sub-p> & (Sp+ & <CLAUSE>));
