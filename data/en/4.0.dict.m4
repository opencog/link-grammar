...
% Dictionary version number is 5.2.3 (formatted as V5v2v3+)
<dictionary-version-number>: V5v2v3+;
...
say.q hiss.q: {@E-} & (((Sp- or I-) & <vc-paraph>) or (SIpj+ & <vc-paraph-inv>));
says.q hisses.q: {@E-} & ((Ss- & <vc-paraph>) or (SIsj+ & <vc-paraph-inv>));
said.q-d hissed.q-d: {@E-} & (((S- or PP-) & <vc-paraph>) or (SI*j+ & <vc-paraph-inv>));
saying.q hissing.q: {@E-} & Pg- & <vc-paraph>;
...
LEFT-WALL:
  ((Wa+ or Wi+ or Ww+ or Qd+) & {CP+} & {Xx+ & {hWV+}} & {RW+ or Xp+})
